...
void swap_file() {
	...
	if(swap_total < 1)	cout << "Swap Total/Free/Used:		" << swap_total * 1000 << "/" << swap_free * 1000 << "/" << swap_used * 1000 << " MB" << endl;
	else			cout << "Swap Total/Free/Used:		" << swap_total << "/" << swap_free << "/" << swap_used << " GB" << endl;
}
